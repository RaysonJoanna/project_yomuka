...
public class Play {
	...
	public static void playWalk(Customer customer,PetHash petHash) {
		
		Scanner sc = new Scanner(System.in);
		Pet myPet = new Pet();
		
		System.out.println("산책&놀이를 선택하셨습니다.");
		System.out.println("함께 놀아주시겠습니까?");
		...
		case "1" : 
			...
			System.out.println(myPet.name  + "의 건강한 생활을 응원합니다!");
