...
public class Teeth {
	...
	public static void brushTeeth(Customer customer,PetHash petHash) {
		Pet myPet = new Pet();
		Scanner sc = new Scanner(System.in);
		
		System.out.println("양치를 선택하셨습니다.");
		System.out.println("양치를 시키시겠습니까?");
		...
		case "1" : 
			...
			System.out.println(myPet.name + "의 건강한 이빨을 지켜주세요!");
